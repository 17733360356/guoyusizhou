...
u8 Init_HMC5883L(void)
{
	...
	I2C_INIT();
	Single_Write(HMC5883L_Addr,0x00,0x70);
	Single_Write(HMC5883L_Addr,0x01,0x20);
   Single_Write(HMC5883L_Addr,0x02,0x00);
	
	tempA= Single_Read(HMC5883L_Addr, 0x0A);
	tempA= Single_Read(HMC5883L_Addr, 0x0B);
	tempA= Single_Read(HMC5883L_Addr, 0x0C);
   return 1; 		 
}
...
//		u8 i=0;
	...
	HMC5883L_buffer[0]= Single_Read(HMC5883L_Addr, 0x03);
	HMC5883L_buffer[1]= Single_Read(HMC5883L_Addr, 0x04);
	
	HMC5883L_buffer[2]= Single_Read(HMC5883L_Addr, 0x05);
	HMC5883L_buffer[3]= Single_Read(HMC5883L_Addr, 0x06);
	
	HMC5883L_buffer[4]= Single_Read(HMC5883L_Addr, 0x07);
	HMC5883L_buffer[5]= Single_Read(HMC5883L_Addr, 0x08);
